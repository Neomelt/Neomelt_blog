...
![Clash Verge 的 Profiles 页面：右键 Global Extend Config 卡片弹出 Edit File 菜单](../../assets/blog/claude-sign-up-guide/1.png)

然后右键edit进入代码界面,将自己的节点名称写进去（一个字也不能错）

![Global Extend Config 编辑框：用 prepend-rules 把 claude.ai 和 anthropic.com 固定到同一节点](../../assets/blog/claude-sign-up-guide/2.png)
