...
export const UI_TRANSLATIONS = {
    zh: {
        ...
        "about.distributionLead": "主站统一使用 www.neomelt.cloud。若主站在你当前网络下访问不稳定，可切换到备用入口。",
        "about.distributionHint": "根域名 neomelt.cloud 会自动跳转到主站；GitHub Pages Direct 仅作为备用访问入口。",
    ...
    en: {
        ...
        "about.distributionLead": "The canonical site lives at www.neomelt.cloud. If it is unstable on your network, you can use the fallback entry.",
        "about.distributionHint": "The root domain neomelt.cloud now redirects to the primary site. GitHub Pages Direct is kept only as a fallback.",
